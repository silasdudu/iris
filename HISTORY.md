...
- `import "github.com/iris-contrib/plugin/oauth"` -> `import "github.com/kataras/iris/adaptors/oauth"`
...
**Iris' Adaptors** for these policies can be found at [/adaptors folder](https://github.com/kataras/iris/tree/master/adaptors).
The folder contains:
...
- oauth/oauth2, an authentication system adapted as `EventPolicy`
...
Example can be found [here](https://github.com/kataras/iris/tree/master/adaptors/oauth/_example).
